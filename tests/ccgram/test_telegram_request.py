...
class TestCreateBotPollingRequest:
    ...
    def test_uses_resilient_request_for_telegram_traffic(
        ...
        # CCGRAM-HOTFIX:file-dl-timeouts — main Bot API request uses a long
        # read_timeout (60s, not upstream's 10s) so getFile/download_to_drive
        # survives cold VPN-exit connections that need 5-6s.
        assert app.bot._request[1].read_timeout == 60
