...
def test_register_all_registers_all_handler_kinds():
    ...
    # 9 MessageHandlers: FORUM_TOPIC_CLOSED, FORUM_TOPIC_CREATED (fork:
    # CCGRAM-HOTFIX:sticky-create-name), FORUM_TOPIC_EDITED, COMMAND fallback,
    # TEXT, PHOTO, Document.ALL, VOICE, catch-all unsupported = 9
